...
global.wm = '                「 𝙱𝙾𝚃𝙺𝙸𝙽𝙶𝙳𝙾𝙼 あ⁩ 」' //Main Watermark

global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘օառɛʀ - 𝚜𝚞𝚙𝚞𝚗𝚊˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'

global.wm3 = '⫹⫺ 𝙱𝙾𝚃𝙺𝙸𝙽𝙶𝙳𝙾𝙼'

global.botdate = `⫹⫺ Date :  ${moment.tz('Asia/Colombo').format('DD/MM/YY')}`

global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${moment.tz('Asia/Colombo').format('HH:mm:ss')}`

global.titlebot = `⫹⫺ Time Sever : ${moment.tz('Asia/Colombo').format('HH:mm:ss')}\n⫹⫺ Date Server :  ${moment.tz('Asia/Colombo').format('DD/MM/YY')}
`

global.author = '                「 Supuna あ⁩ 」'
...
global.sgc = 'https://chat.whatsapp.com/BKkm0CwyiN16RqRPFHc6U4'
global.sig = 'https://chat.whatsapp.com/BKkm0CwyiN16RqRPFHc6U4'
//========Url Template Buttons=========//
global.dtu = 'Botkingdom'
global.urlnya = "https://chat.whatsapp.com/BKkm0CwyiN16RqRPFHc6U4"

//============= callButtons =============//
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '+1 111-111-1111'
...
/*============== NOMOR ==============*/
global.nomorbot = '+94756845221'
global.nomorown = '94756845221'
global.namebot = 'Botkingdom'
global.nameown = 'supuna'
