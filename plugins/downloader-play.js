...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!vid) throw 'Video/Audio සොයා ගත නොහැක'
  ...
  let buttons = [{ buttonText: { displayText: 'වීඩියෝවද ලබා ගන්න' }, buttonId: `${usedPrefix}ytv ${url}` }]
  let msg = await conn.sendMessage(m.chat, { image: { url: thumbnail }, caption: capt, footer: '_.https://chat.whatsapp.com/BKkm0CwyiN16RqRPFHc6U4.._', buttons }, { quoted: m })
